...
from rabbitears.guide_builder import GuideBuilder
...
class GuideWindowConf:
    def __init__(self, w=720, h=480):
        ...
        self.footer_messages = ["You are watching RabbitEars TV", "Now with cable mode."]
...
class GuideApp(tk.Tk):
    def __init__(self, user_conf, queue=None):
        ...
        self.title("RabbitEars TV Guide")
