...
class AutoBumpAgent:
    ...
    def resolve_bg_video_path(bg_video):
        ...
        video_path = os.path.join("rabbitears", "rabbitears_server", "static", "bump", "video", str(bg_video))
    ...
    def resolve_bg_video_url(bg_video):
        ...
        # absolute URLs served from this RabbitEars instance can pass through
