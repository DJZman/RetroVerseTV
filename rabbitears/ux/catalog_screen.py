...
from rabbitears.ux.dialogs import SelectStationErr, LoadingScreen
        ...
        for station in StationManager().stations:
            ...
            if "catalog_path" in station:
                try:
                    ...
                    self.dt.add_row(network_name, station["channel_number"], station["network_type"], vcount, tcount)
                except FileNotFoundError:
                    self.dt.add_row(
                        network_name, station["channel_number"], station["network_type"], "No catalog", "No catalog"
                    )
            else:
                pass
