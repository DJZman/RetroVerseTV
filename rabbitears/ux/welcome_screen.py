...
from rabbitears.ux.dialogs import QuitScreen
from rabbitears.ux.catalog_screen import CatalogScreen
from rabbitears.ux.schedule_screen import ScheduleScreen
