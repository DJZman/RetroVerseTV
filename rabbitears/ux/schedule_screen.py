...
from rabbitears.ux.dialogs import SelectStationErr, LoadingScreen, GeneralErr
        ...
        match event.button.id:
                ...
                if val == Select.BLANK:
                    ...
                    if schedule is None:
                        ...
                        for _block in schedule:
                            ...
                            self.dt.add_row(
                                _block.start_time.strftime("%m/%d %H:%M"),
            ...
            case "rebuild_all":
                ...
                if all_found:
                    ...
                    es = GeneralErr(
                        "Some stations do not have catalogs built. Select 'Back' and then 'Manage Catalogs' to build."
                    )
