...
from rabbitears.osd.content_classifier import ContentType, classify_current_content
...
class LogoDisplay(object):
    ...
    def find_content_logo_dir(self, base_dir: Path, station_data: dict) -> Path | None:
        ...
        if file_path and content_dir:
            ...
            # or absolute. Example:
            #   file_path:    /home/user/RabbitEars TV/catalog/MTV/daria/foo.mp4
    ...
    def select_logo_for_channel(self, station_data: dict) -> Path | None:
        ...
        # Original RabbitEars semantics: logo_dir relative to content_dir
