...
from rabbitears.liquid_manager import LiquidManager, ScheduleNotFound, ScheduleQueryNotInBounds
from rabbitears.liquid_blocks import LiquidBlock
...
class GuideBuilder:
    def __init__(
        self, num_blocks=3, template_dir="rabbitears/guide_render/templates/", static_dir="rabbitears/guide_render/static/"
    ):
