...
class TickerWindow(QWidget):
    def __init__(self, parent=None):
        ...
        self.color_schemes = {
            ...
            'rabbitears': {
                'header_start': QColor(40, 80, 140, 240),   # RabbitEars TV blue
        ...
        # Default values
        self.current_style = 'rabbitears'
        self.header_title = "RabbitEars"
        self.logo_pixmap = None
        self.load_rabbitears_logo()
    ...
    def load_rabbitears_logo(self):
        """Load RabbitEars TV logo if available"""
        logo_paths = [
    ...
    def show_message(self, text, title="RabbitEars", style="rabbitears", iterations=2):
    ...
    def paintEvent(self, event):
        ...
        try:
            ...
            print(f"Warning: Style '{self.current_style}' not found, using default 'rabbitears' style")
            scheme = self.color_schemes['rabbitears']
...
def run_ticker_app(text, title="RabbitEars", style="rabbitears", iterations=2):
    ...
    app = SingleApplication(sys.argv, "RabbitEars_Ticker_SingleInstance")
...
def run_ticker(text, title="RabbitEars", style="rabbitears", iterations=2):
...
if __name__ == '__main__':
    ...
    run_ticker_app("Welcome to RabbitEars TV - Your retro TV experience")
    print("Done")