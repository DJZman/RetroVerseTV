        ...
        if not self._initialized:
            ...
            if not len(self.stations):
                ...
                self.server_conf = {
                    ...
                    "db_path": "runtime/rabbitears_fluid.db",
                    "start_mpv": True,
                    "server_host": "0.0.0.0",
                    "server_port": 4242,
                    "title_patterns": [],
            ...
            for i in range(len(self.stations)):
                ...
                if station["network_type"] == "guide":
                    ...
                    from rabbitears.guide_tk import GuideWindowConf
        ...
        if d is not None:
            try:
                ...
                if "date_time_format" not in d:
                    ...
                    self.server_conf["date_time_format"] = os.environ.get("RabbitEars_TS", "%Y-%m-%dT%H:%M:%S")
                else:
