...
Video-on-demand interface for RabbitEars TV. Browse movies with page up/down keys, hit ENTER to play. Shows a slideshow with posters, titles, and descriptions.
...
NFO files are just ascii text files - RabbitEars will parse them looking for the first 3 lines to be:
1. Title
...
Create `rabbitears/rabbitears_server/static/ppv/music_playlist.json`:
