...
RabbitEars TV includes 7 background music tracks: `logo0.mp3` through `logo6.mp3`
...
**Add your own music:**
1. Copy files to `rabbitears/rabbitears_server/static/bump/music/`
2. Use filename in `bg_music` parameter

## Programming Integration

Show upcoming shows from RabbitEars TV schedule:
...
- Verify network name exists in RabbitEars TV
- Check RabbitEars TV server is running
...
## File Structure
```
rabbitears/rabbitears_server/static/bump/
