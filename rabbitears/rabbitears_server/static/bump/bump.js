class StationBump {
    constructor(config = {}) {
        ...
        this.config = {
            ...
            details: ['Transmitting 24/7', 'On RabbitEars TV', 'It\'s up to you!'],
    ...
    async loadNextUpShows() {
        try {
            ...
            const scheduleBlocks = await window.rabbitearsCommon.fetchSchedule(
                this.config.nextUp,
    ...
    static fromURLParams() {
        ...
        const config = {
            title: params.get('title') || 'RabbitEars TV',
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (hasParams) {
        ...
        // Default configuration for RabbitEars TV
